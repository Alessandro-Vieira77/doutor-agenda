...
const doctorSchema = z
  .object({
    ...
    availableFromWeekDay: z.string().trim().min(1, "Selecione um dia"),
    availableToWeekDay: z.string().trim().min(1, "Selecione um dia"),
  ...
  const form = useForm<z.infer<typeof doctorSchema>>({
    ...
    defaultValues: {
      ...
      appointmentPriceInCents:
        Number(doctor?.appointmentPriceInCents) / 100 || 100,
    },
  });
  ...
  return (
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription>
          {doctor ? "Edite os dados do médico" : "Adicione um novo médico"}
        </DialogDescription>
      </DialogHeader>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Dia incial de disponibilidade</FormLabel>
                <FormControl>
                  <Select
                    onValueChange={field.onChange}
                    defaultValue={field.value}
