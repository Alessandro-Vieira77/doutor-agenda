...
- Ao criar páginas, use os componentes dentro de [reusables-containers.tsx](mdc:src/components/reusables-containers.tsx) para manter os padrões de margin, padding e spacing nas páginas. Exemplo: [page.tsx](<mdc:src/app/(protected)/doctors/page.tsx>).
